...
'direct electron transfer', 'extracellular electron transfer'], 
...
'formate production', 'proton generation', 'low pH', 'carbonic acid', 'citric acid', 'gluconic acid'], 
...
'respiratory burst', 'oxygen depletion'], 
...
'attachment', 'surface', 'adherence', 'biofilm maturation', 'quorum sensing', 'alginate production', 'cellulose production'], 
...
'nitrous oxide reduction', 'ammonia oxidation', 'anammox', 'nitrogen fixation', 'ammonification'], 
'manganese_metabolism': ['manganese oxidation', 'manganese reduction', 'Mn-oxide formation', 'Mn-oxide dissolution', 'Mn cycling', 
'birnessite formation', 'pyrolusite formation', 'Mn precipitation'], 
...
'sulfur respiration', 'sulfite reduction', 'elemental sulfur', 'polysulfide'], 
...
'metal solubilization', 'mineral dissolution', 'mineral precipitation', 'metal mobilization', 'co-precipitation', 'biosorption'], 
...
'iron-sulfur cluster', 'ferritin', 'bacterioferritin', 'heme biosynthesis'], 
...
'chelate formation', 'metal ligand'], 
...
'carbon catabolite repression', 'carbonation', 'carbonate precipitation'], 
'ph_modulation': ['acid tolerance', 'alkaline tolerance', 'proton pump', 'pH homeostasis', 'pH stress', 'pH regulation', 'acid resistance', 
'pH buffering', 'pH gradient', 'acidophile', 'alkaliphile'], 
'exoelectrogenesis': ['exoelectrogen', 'electrochemically active bacteria', 'EAB', 'extracellular respiration', 'electrode respiration', 
'bioelectrosynthesis', 'microbial fuel cell'], 
'enzymatic_corrosion': ['enzyme-mediated corrosion', 'metalloenzyme', 'enzyme-catalyzed oxidation', 'enzyme-catalyzed reduction', 
'peroxidase', 'laccase', 'oxidoreductase activity'], 
'dealloying': ['selective corrosion', 'dezincification', 'dealuminification', 'parting', 'selective leaching', 
'alloy corrosion', 'preferential dissolution'], 
'galvanic_corrosion': ['bimetallic corrosion', 'galvanic couple', 'differential aeration', 'local cell formation', 
'microelectrochemical cells', 'electrolytic corrosion'], 
'chloride_attack': ['chloride-induced corrosion', 'pitting initiation', 'localized corrosion', 'crevice corrosion', 
'stress corrosion cracking', 'chloride penetration'], 
'microbe_metal_synergy': ['metal-microbe interaction', 'biomineralization', 'biosorption', 'bioaccumulation', 
'metal-binding proteins', 'metallothionein', 'metal-enzyme complex'], 
# Added missing critical mechanisms based on literature (NEW ADDITIONS):
'cathodic_depolarization': ['cathodic depolarization', 'hydrogen depolarization', 'cathodic reaction enhancement', 
'electron acceptor consumption', 'cathodic process acceleration'],
'passivity_breakdown': ['passivation breakdown', 'passive film disruption', 'oxide layer dissolution', 
'passive layer damage', 'depassivation'],
'concentration_cells': ['concentration cell', 'differential concentration', 'ion concentration gradient', 
'oxygen concentration cell', 'metal ion gradient']
}
...
'reactive oxygen species', 'peroxidase', 'oxygen-limited growth' 
],
'nitrogen_metabolism': [
...
'Mn-oxide formation', 'Mn-oxide reduction', 'Mn precipitation', 'Mn dissolution' 
], 
'iron_sulfur_redox': [
...
'iron mobilization', 'iron immobilization', 'iron precipitation' 
],
'ocre_formation': [
...
'biogenic iron oxides', 'stalactite formation', 'ochre mats' 
],
'sulfur_metabolism': [
...
'sulfur globules', 'elemental sulfur', 'polysulfide metabolism', 'sulfur granules' 
],
'electron_transfer': [
...
'electron bridge', 'solid-state electron transfer', 'interfacial electron transfer' 
],
...
'gluconic acid', 'tartaric acid', 'caproic acid', 'valeric acid' 
],
...
'alginate synthesis', 'cellulose biosynthesis', 'amyloid fiber', 'biofilm architecture' 
],
'carbon_metabolism': [
...
'carbon catabolite repression', 'carbon storage', 'glycogen metabolism' 
],
'ph_modulation': [
...
'pH gradient maintenance', 'pH sensing', 'pH buffering system' 
],
'temp_response': [
...
'hypochlorite', 'chlorate reduction', 'perchlorate reduction' 
],
'methanogenesis': [
...
'synthesis': ['biosynthesis', 'anabolism', 'synthesis', 'polymerization', 'assembly', 'synthase', 'ligase', 'transferase', 'acetyl-coa', 'malonyltransferase', 'acyltransferase',
'construction', 'formation', 'production', 'biogenesis', 'neosynthesis'], 
'transport': ['transport', 'uptake', 'export', 'secretion', 'efflux', 'influx', 'permease', 'transporter', 'carrier protein',
'extrusion', 'import', 'transmembrane transport', 'translocation', 'diffusion', 'facilitated transport'], 
'modification': ['modification', 'conversion', 'transformation', 'transmutation', 'decarboxylase', 'transaminase', 'methyltransferase', 'isomerase', 'lyase',
'alteration', 'rearrangement', 'isomerization', 'conjugation', 'methylation', 'hydroxylation'], 
'respiration': ['respiration', 'electron transport chain', 'oxidative phosphorylation',
'terminal electron acceptor', 'cytochrome', 'anaerobic respiration', 'substrate-level phosphorylation'], 
'fermentation': ['fermentation', 'anaerobic metabolism', 'mixed acid fermentation',
'alcohol fermentation', 'lactic acid fermentation', 'homolactic fermentation', 'heterolactic fermentation'], 
'oxidation': ['oxidation', 'oxidase', 'oxidoreductase', 'dehydrogenase',
'hydroxylation', 'oxygenase', 'monooxygenase', 'dioxygenase'], 
'reduction': ['reduction', 'reductase', 'hydrogenase', 'dehydrogenase','3-oxoacyl reductase', 'enoyl reductase', 'beta-ketoacyl reductase', 'ketoacyl reductase',
'nitrate reduction', 'sulfate reduction', 'electron donation', 'reduction potential'],
...
'iron_sulfur_redox': {
'terms': ['iron_metabolism', 'sulfur_metabolism', 'iron_oxidation', 'iron_reduction', 'iron reduction', 'ferric reduction', 'sulfate reduction', 'sulfide', 'sulfite', 
'thiosulfate', 'sulfur oxidation', 'SRB', 'iron-sulfur cluster', 'rubredoxin', 'ferredoxin'], 
...
'acid_production': {
'terms': ['acid', 'acidification', 'fermentation', 'lactic acid', 'formic acid', 'acetic acid', 'oxalic acid', 'organic acid', 'acetate production', 
'lactate metabolism', 'formate production', 'carbonic acid', 'citric acid'], 
...
'terms': ['direct_eet', 'redox', 'electron_transfer', 'omc', 'deet', 'cytochrome', 'electron transfer', 'conductive pili', 'nanowire', 
'mtrABC', 'omcS', 'oxidoreductase', 'redox', 'reductase', 'oxidase', 'extracellular electron transfer'], 
...
'biofilm_formation': {
'terms': ['biofilm_formation', 'metal_chelation', 'quorum_sensing', 'extracellular_matrix', 'EPS', 'surface_disruption', 'polysaccharide', 'adhesin', 'biofilm', 
'extracellular polymeric substance', 'curli', 'exopolymer', 'extracellular matrix', 'adhesion', 'colonization', 'attachment', 'alginate', 'cellulose'], 
'score': 1.3, # INCREASED for HVAC - biofilms major problem in closed systems
...
'terms': ['metal_chelation', 'metal_binding', 'siderophore', 'complexation', 'chelator', 'metallophore', 'iron complex', 'metal transport', 'chelate formation', 'metal ligand'], 
...
'ocre': {
'terms': ['ocre', 'iron_oxide', 'iron_deposit', 'metal oxide', 'ochre formation', 'iron oxide deposits', 'iron precipitation', 'rust formation', 'ferrihydrite', 'goethite', 'magnetite'], 
...
'nitrogen_reduction': {
'terms': ['denitrification', 'nitrate_reduction', 'nitrite_reduction', 'nitrate respiration', 'nitrous oxide reduction', 'nitric oxide metabolism'], 
...
'manganese_reduction': {
'terms': ['manganese_reduction', 'mn_redox', 'manganese oxidation', 'birnessite formation', 'pyrolusite formation'], 
...
'sulfide_production': {
'terms': ['sulfide', 'sulfur_reduction', 'desulfovibrio', 'hydrogen sulfide', 'H2S', 'sulfide precipitation'], 
...
'methanogenesis': {
'terms': ['methanogenesis', 'methanobacterium', 'archaea', 'methane production', 'methyl-coenzyme M reductase'], 
...
'h2_consumption': {
'terms': ['h2_consumption', 'hydrogenase', 'hydrogen uptake', 'hydrogen consumption', 'h2', 'H2 oxidation', 'H2ase', 'hydrogen metabolism'], 
...
'fumarate_formation': {
'terms': ['fumarate', 'propionibacterium', 'fumarate reduction', 'fumarate respiration'], 
'score': 0.5 # Lower priority in HVAC
},
'nitrogen_metabolism': {
'terms': ['nitrogen_metabolism', 'nitrification', 'ammonification', 'nitrogen fixation', 'anammox'], 
'score': 1.0,
'justification': 'Nitrogen cycling influences local redox and pH conditions in water systems'
},
'exoelectrogenesis': {
'terms': ['exoelectrogen', 'electrochemically active bacteria', 'EAB', 'extracellular respiration', 'electrode respiration'], 
...
'enzymatic_metal_oxid': {
'terms': ['metalloenzyme', 'enzyme-catalyzed oxidation', 'peroxidase', 'laccase', 'oxidoreductase activity', 'enzyme-mediated corrosion'], 
'score': 0.8, # secondary to chemical mechanisms
'justification': 'Enzymes can directly catalyze metal oxidation reactions'
},
'metal_precipitation': {
'terms': ['metal precipitation', 'biomineralization', 'mineral formation', 'crystal nucleation', 'metal immobilization'], 
'score': 1.0,
'justification': 'Biomineralization affects local chemistry and surface properties'
},
'ph_buffering': {
'terms': ['pH buffering', 'pH homeostasis', 'acid resistance', 'alkaline tolerance', 'pH gradient'], 
'score': 0.8,
'justification': 'pH regulation affects local corrosion conditions'
},
'chloride_interactions': {
'terms': ['chloride attack', 'chloride-induced corrosion', 'pitting initiation', 'chloride penetration', 'halide corrosion'], 
...
'dealloying_mechanisms': {
'terms': ['selective corrosion', 'dezincification', 'dealuminification', 'preferential dissolution', 'parting'], 
...
'ferric reduction', 'sulfate reduction', 'sulfide', 'sulfite', 
'thiosulfate', 'sulfur oxidation', 'SRB', 'pyrite', 'pyrrhotite'], 
'ocre': ['ocre', 'iron oxide', 'iron deposit', 'metal oxide', 'ochre formation', 
'iron oxide deposits', 'iron precipitation', 'rust formation', 'ferrihydrite', 'goethite'], 
...
'oxidoreductase', 'redox', 'reductase', 'oxidase', 'extracellular electron transfer'], 
...
'alginate', 'cellulose', 'biofilm architecture'], 
...
'chelator', 'metallophore', 'iron complex', 'metal transport', 'chelate formation'], 
'nitrogen': ['denitrification', 'nitrate reduction', 'nitrite reduction', 
'nitrogen metabolism', 'nitrate', 'nitrite', 'nitrification', 'ammonification'], 
'manganese': ['manganese reduction', 'mn redox', 'manganese oxidation', 'mn reduction', 
'birnessite', 'pyrolusite', 'manganese mineral'], 
...
'h2', 'h2 oxidation', 'h2ase', 'hydrogen evolution', 'hydrogen metabolism'], 
'oxygen': ['o2 consumption', 'aerobic respiration', 'oxygen reduction', 'oxygen consumption', 
'oxygen depletion', 'oxygen-limited', 'oxygen stress'], 
