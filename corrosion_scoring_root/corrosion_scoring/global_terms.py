...
'direct_eet':  {'terms': ['cytochrome c oxidase', 'quinol oxidase', 'NADH:quinone oxidoreductase', 'succinate dehydrogenase', 'fumarate reductase', 'cytochrome', 'electron transfer', 'electron transport', 'conductive pili', 'nanowire', 'mtrABC', 'omc', 'omcS', 'oxidoreductase', 'redox', 'reductase', 'oxidase', 'electron conduit', 'direct electron transfer', 'deet', 'c-type cytochrome', 'multi-heme cytochrome', 'flavin', 'electron shuttle','histidine kinase','PROTEIN-KINASE-RXN', 'L-arginine biosynthesis II', 'chorismate biosynthesis I', 'superpathway of branched amino acid biosynthesis', 'superpathway of aromatic amino acid biosynthesis', 'L-lysine biosynthesis I', 'L-ornithine biosynthesis', 'oxidoreductase activity'], 'score': 1.3, 'justification':  'Jones, D.A. (1996). Principles and Prevention of Corrosion, 2nd ed. All corrosion fundamentally involves electron transfer'},# Important but secondary to chemical mechanisms in HVAC	
