...
class TermProcessor:
    ...
    def __init__(self, taxonomy: dict):
        ...
        'direct_eet', 'biofilm_formation', 'o2_consumption', 'metal_binding_chelation',
        'nitrogen_metabolism', 'manganese_processes', 'h2_consumption', 'halogen_related',
        'methanogenesis', 'carbon_metabolism', 'indirect_eet', 'fumarate_formation',
