...
"""
Corrosion Relevance Scoring System
==================================

Core scoring functions for corrosion relevance evaluation.
"""
...
import global_terms_py.global_terms_py as gt

# Import all term dictionaries 
metal_terms = gt.metal_terms
corrosion_mechanisms = gt.corrosion_mechanisms
pathway_categories = gt.pathway_categories
organic_categories = gt.organic_categories
corrosion_synergies = gt.corrosion_synergies
functional_categories = gt.functional_categories
corrosion_keyword_groups = gt.corrosion_keyword_groups
metal_mapping = gt.metal_mapping

'''
import math
from typing import Dict, List, Tuple, Union, Any

# Import all term dictionaries from global_terms.py
